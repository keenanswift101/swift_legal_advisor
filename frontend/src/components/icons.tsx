// Inline SVG icon components — Heroicons 2.0 style (24px, stroke-based)
...
export function ScaleIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 4.95a.75.75 0 010 .558l-2.62 4.95m-13.5-10.45C4.99 5.287 4.99 5.287 3 5.49m3.75-.52l-2.62 4.95a.75.75 0 000 .558l2.62 4.95m-2.62-4.95h13.5" />
    </svg>
  )
}
...
export function FolderIcon({ className = 'w-10 h-10' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function PrinterIcon({ className = 'w-3.5 h-3.5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function LoaderIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BanknotesIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function NamibiaFlag({ className = 'w-8 h-auto' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 36 24" role="img" aria-label="Namibian flag">
      {/* Blue upper-left triangle */}
      <polygon points="0,0 0,16.2 24.3,0" fill="#003FA0" />
      {/* Green lower-right triangle */}
      <polygon points="36,7.8 36,24 11.7,24" fill="#009540" />
      {/* Red diagonal band */}
      <polygon points="0,18.6 27.9,0 36,0 36,5.4 8.1,24 0,24" fill="#C8102E" />
      {/* White upper border */}
      <polygon points="0,16.2 24.3,0 27.9,0 0,18.6" fill="white" />
      {/* White lower border */}
      <polygon points="8.1,24 36,5.4 36,7.8 11.7,24" fill="white" />
      {/* Golden sun disc */}
      <circle cx="8" cy="7.5" r="2.8" fill="#FFD700" />
      {/* 12 sun rays */}
      <g stroke="#FFD700" strokeWidth="0.7" strokeLinecap="round">
        <line x1="8" y1="3.5" x2="8" y2="2" />
        <line x1="10.4" y1="4.1" x2="11.6" y2="2.9" />
        <line x1="11.3" y1="6.6" x2="13" y2="6.1" />
        <line x1="10.4" y1="9.2" x2="11.6" y2="10.4" />
        <line x1="8" y1="10.3" x2="8" y2="12" />
        <line x1="5.6" y1="9.2" x2="4.4" y2="10.4" />
        <line x1="4.7" y1="6.6" x2="3" y2="6.1" />
        <line x1="5.6" y1="4.1" x2="4.4" y2="2.9" />
      </g>
    </svg>
  )
}
